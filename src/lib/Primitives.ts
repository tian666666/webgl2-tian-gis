...
export class GeometryData {
  ...
  public makeStaticVAO(
    ...
    let arrayBuffer: ArrayBuffer = new ArrayBuffer(
      stride * this.positions.length
    );
    ...
    let mesh: GLStaticMesh = new GLStaticMesh(
      gl,
      bits,
      buffer,
...
export class Cube {
  ...
  public constructor(
    halfWidth: number = 0.2,
    halfHeight: number = 0.2,
    halfDepth: number = 0.2
  ) {
