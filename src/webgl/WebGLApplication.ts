// WebGLApplication 继承 Application 的所有功能，并增加了 WebGL 相关的功能
...
export class WebGLApplication extends Application {
  ...
  protected ctx2D: CanvasRenderingContext2D | null = null; // 用来在 WebGL 渲染的同时支持使用 Canvas2D 来绘制二维物体或文字，由于 2D 和 3D 具有不同的坐标系统，因此将 2D 屏幕坐标转换为 3D 坐标系或相反的操作，需要进行一些必要的数学操作
  ...
  public constructor(
    ...
    if (need2D === true) {
      ...
      canvasElem.addEventListener("mousewheel", this, false);
